...
$query  = mysql_query("SELECT * FROM pendaftaran,jenis_beasiswa WHERE pendaftaran.kd_jenisbeasiswa=jenis_beasiswa.kd_jenisbeasiswa and npm='".$kode."'");
...
echo '<table border="0" width="100%">
  ...
  <tr>
    <td align="center"><b>BUKTI PENDAFTARAN</b></td>
  </tr>
  <tr>
...
echo "<div align='justify'><p>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; SILAHKAN DISIMPAN SEBAGAI BUKTI BAHWA ANDA TELAH MENDAFTAR</p></div><p><br></p>";
?>
</body>
