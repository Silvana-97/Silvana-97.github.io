...
<div class="about">
		<div class="container">
			<h3 class="heading-agileinfo">AMIK MBP MEDAN<span>Informasi Detail Syarat-syarat Penerimaan Beasiswa</span></h3>
			<div class="col-md-12 about-w3right">
            	<table id="example1" class="table table-bordered table-striped" width="100%">
                     ...
                     <tr>
                       <td colspan="3">INFORMASI SYARAT-SYARAT PENERIMAAN BEASISWA</td>
                     </tr>
                     <tr>
