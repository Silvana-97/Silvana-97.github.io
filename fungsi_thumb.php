<?php
// Upload foto untuk panitia
function UploadImage($fupload_name){
  //direktori gambar
  $vdir_upload = "../../../foto_panitia_hrd/";
...
// Upload foto untuk pegawai
function UploadImage_pegawai($fupload_name){
  //direktori gambar
  $vdir_upload = "../../../foto_pegawai/";
  $vfile_upload = $vdir_upload . $fupload_name;
...
// Upload foto untuk Berita
function UploadImage_berita($fupload_name){
  //direktori gambar
