...
<div class="about">
		<div class="container">
			<h3 class="heading-agileinfo">LOGIN CEK KELULUSAN BERKAS<span>Akademik Manajemen Informatika Komputer Medan</span></h3>
            ...
            <form action="proseslogin.php" method="post">
                ...
                <tr>
                  ...
                  <td>:</td>
                    <td><input name="password" type="password" class="form-control" size="50" placeholder="MASUKKAN PASSWORD ANDA" /></td>
                </tr>
                <tr>
