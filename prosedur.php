...
<div class="about">
		<div class="container">
			<h3 class="heading-agileinfo">AMIK MBP MEDAN <span>Informasi Prosedur Pendaftaran Beasiswa</span></h3>
            ...
            <table id="dataTables" class="display" cellspacing="0" width="100%" style="font-size:13px;">
                                            ...
                                            <tbody>
												...
												$counter = 1; 
												include"koneksi.php";
													$query = mysql_query("select * from content_beasiswa,jenis_beasiswa where content_beasiswa.kd_jenisbeasiswa=jenis_beasiswa.kd_jenisbeasiswa and kategori_cbeasiswa='Prosedur' and status_cbeasiswa='Y' order by id_cbeasiswa DESC");
